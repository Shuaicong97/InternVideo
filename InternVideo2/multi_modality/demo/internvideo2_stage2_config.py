...
model = dict(
    ...
    vision_encoder=dict(
        ...
        pretrained='/root/autodl-tmp/InternVideo/hub/models--OpenGVLab--InternVideo2-Stage2_1B-224p-f4/snapshots/4362e1f88a992e7edbfd7696f7f78b7f79426dfd/InternVideo2-stage2_1b-224p-f4.pt',
        use_checkpoint=True,
        checkpoint_num=40,
